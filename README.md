...
> Lightweight date formatting (no moment.js)

[![npm version](https://badge.fury.io/js/date-format-js.svg)](https://www.npmjs.com/package/date-format-js)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install date-format-js
```

## Quick Start

```javascript
const { js } = require('date-format-js');
...
```javascript
const { js, batch } = require('date-format-js');
